#
#  Be sure to run `pod spec lint SITABLE.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "宋军"
  # s.authors            = { "宋军" => "songjun_0806@163.com" }
  # s.social_media_url   = "http://twitter.com/宋军"
  ...
  s.source_files  = "SITABLE", "SITABLE/**/*.{h,m}"
